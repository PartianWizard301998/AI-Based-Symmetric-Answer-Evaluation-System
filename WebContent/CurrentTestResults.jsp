...
<body class="cbp-spmenu-push" style="background-color:#981212">
  ...
  <div class="panel-body">
		   ...
		   <% }
			...
			<% 
			try{
			 PreparedStatement prst32=con.prepareStatement("select * from testattendance ts,studentdata sd where ts.TestId=? and sd.studid=ts.studid ");
			 ...
			 %>
		      <tr class="danger">
		       ...
		       <td><%out.println(rs12.getString(5)); %></td>
		         <td><a href="ViewSolvedQuestion.jsp?testid=<%out.println(testid);%>&studid=<%out.println(rs12.getString(2)); %>">View Solved</a></td>
