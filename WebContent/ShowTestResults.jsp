						...
						<ul class="nav" id="side-menu">
							...
							<li>
								...
								<ul class="nav nav-second-level collapse">
									...
									<li>
										<a href="404.html">Search For Results</a>
									</li>
								</ul>
								<!-- //nav-second-level -->
							</li>
	...
	<div class="col-md-2">
		...
		<div id="page-wrapper">
			...
			String testid=request.getParameter("id");
			 ...
			 PreparedStatement prst3=con.prepareStatement("select * from testdetails where TestId=?");
			 prst3.setString(1, testid);
		   ...
		   <% }
			...
			<%
			 ...
			 PreparedStatement prst32=con.prepareStatement("select * from results where TestId=?");
			 prst32.setString(1,testid);
			 ...
			 %>
		      ...
		      <td><%out.println(rs12.getString(2)); %></td>
		       <td><%out.println(rs12.getString(3)); %></td>
		         <td><%out.println(rs12.getString(4)); %></td>
