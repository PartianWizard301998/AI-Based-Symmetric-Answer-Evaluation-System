...
<body class="cbp-spmenu-push" style="background-color:#981212;">
  ...
  <div class="panel-body">
		      ...
		      <input type="text" name="testtitle" placeholder="Enter Test Title"  class="form-control">
		      <br/>
		      ...
		      <br/>
		       ...
		       <input type="number" name="total_marks" placeholder="Enter Test Mark"  class="form-control">
		       <br/>
		        <input type="number" name="min_pass_marks" placeholder="Enter Minimum Passing Mark"  class="form-control">
		       <br/>
		       <input type="number" name="test_time" placeholder="Enter Total Test Time"  class="form-control">
		       <br/>
		      <input type="submit" value="Create Test" name="search">
		      </form>
		       <br/>
		      <br/>
            ...
            while(rs.next()){
		      ...
		      <td><a href="AddQuestion.jsp?id=<%out.println(""+rs.getString(1)); %>&title=<%out.println(""+rs.getString(2)); %>"><input type="submit" value="Add Question" ></a></td>
		      </tr>
            ...
            %>
		      ...
		      if(str1!=null){
		         ...
		         Class.forName("com.mysql.jdbc.Driver");
	             Connection con= DriverManager.getConnection("jdbc:mysql://localhost/DescriptiveAnswer","root","root");
	             PreparedStatement prst=con.prepareStatement("insert into testdetails(TestTitle,TestSubject,TotalMark,PassMark,TestTime,isLive) values(?,?,?,?,?,?) ");
	             prst.setString(1, title);
	             prst.setString(2, testsubject);
	             prst.setString(3, total_marks);
	             prst.setString(4, min_pass_marks);
	             prst.setString(5, test_time);
	             prst.setString(6, "0");
	             prst.executeUpdate();
		      %>
		      <script>
