...
<body  style="background-color:#127676;">
  ...
  <div class="panel-heading"><h3> Current Going Test</h3></div>
  <div class="panel-body">
		   ...
		   <% }
			%>
		      		...
		      		<div class="panel panel-default">
  <div class="panel-heading"> <h3> Update the Current Test</h3></div>
  <div class="panel-body">
		    
		     <hr>
		     <%
		    
		     String isclick=request.getParameter("update");
		     if(isclick!=null){
		    	 try{
		    	 String tid=request.getParameter("testid");
		    	  PreparedStatement prst=con.prepareStatement("update testdetails set isLive=?");
		    	  prst.setString(1,"0");
		    	  prst.executeUpdate();
		    	  prst.close();
		    	  PreparedStatement prst2=con.prepareStatement("update testdetails set isLive=? where TestId=?");
		    	  prst2.setString(1,"1");
		    	  prst2.setString(2,tid.trim());
		    	  prst2.executeUpdate();
		    	  %>
		    	  <script>
		    	  
		    	  alert("Test Become Live Sucesfully");
		    	  </script>
             ...
             ResultSet rs=stm.executeQuery("select * from testdetails");
		     while(rs.next()){
		     %>
		     ...
		     <br/>
		     <input type="submit" value="Make Live" name="update">
		     </form>
		     </div>
		     </div>
