...
<body class="cbp-spmenu-push" style="background-color:#981212;">
	...
	<div class="col-md-2">
		...
		<div id="page-wrapper" style="background-color:#981212;">
			...
			<%
		     ...
		     String isclick=request.getParameter("submit");
		     if(isclick!=null){
		    	 try{
			   ...
			   PreparedStatement prst3=con.prepareStatement("select * from studentdata where EnrollmentId=?");
			   prst3.setString(1, "1");
			   ResultSet rs33=prst3.executeQuery();
		       PreparedStatement prst=con.prepareStatement("insert into studentdata(StudName,EnrollmentId,Branch,DOB,email) values (?,?,?,?,?)");
		       prst.setString(1,request.getParameter("std_name"));
		       prst.setString(2,request.getParameter("enrollmentid"));
		       prst.setString(3,request.getParameter("branch"));
		       prst.setString(4,request.getParameter("password"));
  ...
  <div class="panel-body">
		      <form method="post">
		     <input type="text" placeholder="Enter Studet Name" class="form-control" name="std_name">
		     <br/>
		     <input type="text" placeholder="Enter Username" class="form-control" name="enrollmentid">
		      <br/> 
