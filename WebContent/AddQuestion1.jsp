...
<body class="cbp-spmenu-push" style="background-color:#981212;">
  ...
  <div class="panel-body">
		      ...
		      <td><a href="AddQuestion.jsp?id=<%out.println(""+rs.getString(1)); %>&title=<%out.println(""+rs.getString(2)); %>"><span class="label label-primary">Add Question</span></a> |<a href="DeleteTest.jsp?id=<%out.println(""+rs.getString(1)); %>"> <span class="label label-success">Remove Test</span></a></td>
		      </tr>
