	...
	<div class="col-md-2">
		...
		<div id="page-wrapper" style="background-color:#f8f8ff;">
             ...
             String studname="";
				if(stdlog!=null){
					...
					String dob=request.getParameter("dob");
					 ...
					 Connection con= DriverManager.getConnection("jdbc:mysql://localhost/GPAData","root","root");
		  ...
		  <div class="panel panel-default">
               ...
               <hr>
		     <form>
		     <input type="email" placeholder="Enter Username" name="name" class="form-control" required>
		     <br/>
