...
<body class="cbp-spmenu-push">
  ...
  <div class="panel-body">
		   ...
		   <% }
			...
			String get_testid=request.getParameter("testid");
		    
		    %>
		     <a href="AutoMarking.jsp?testid=<%out.println(get_testid);%>&studid=<%out.println(get_studid); %>"><input type="submit" value="Auto Marking"></a>
		     <hr>
			...
			try{
			 ...
			 %>
		      <tr class="danger">
		       <td><%out.println(rs12.getString(10)); %></td>
