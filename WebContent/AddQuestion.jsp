...
<body class="cbp-spmenu-push">
	...
	<div class="col-md-2">
		...
		<div id="page-wrapper" style="background-color:#f8f8ff;">
			...
			%>
			<br/><br/>
			<h3>Test Title:&nbsp;&nbsp; <%out.println(title); %></h3>
			<br/>
		      <form method="post">
		      
		      <input type="text" name="question" placeholder="Enter Question" required class="form-control">
		       <input type="hidden" name="testid" value="<%out.println(id); %>"  placeholder="Enter Question" required class="form-control">
		      <br/>	  
		       <input type="Text" name="option1" placeholder="Enter First Keyword"   class="form-control">
		       <br/>
		        <input type="Text" name="option2" placeholder="Enter Second Keyword"   class="form-control">
		       <br/>
		       <input type="Text" name="option3" placeholder="Enter Third Keyword"   class="form-control">
		       <br/>
		        <input type="Text" name="option4" placeholder="Enter Fourth Keyword"   class="form-control">
		        <br/>
		          <input type="Text" name="answer" placeholder="enter fifth keyword"   class="form-control">
		        <br/>
		        <input type="Text" name="mark" placeholder="Enter Mark of Question" required  class="form-control">
		        <br/>
		      <input type="submit" value="Add Question" name="search">
		      </form>
		       <br/>
		      <br/>
            ...
            PreparedStatement prst=con.prepareStatement("select * from questions Where TestId="+id);
           // prst.setString(1,"4");
            ...
            while(rs.next()){
		     ...
		     <td><%out.println(rs.getString(6)); %></td>
		      ...
		      <td><a href="UpdateQuestion.jsp?id=<%out.println(""+rs.getString(1)); %>"><span class="label label-primary">Update Question</span></a> |<a href="DeleteQuestion.jsp?id=<%out.println(""+rs.getString(1)); %>"> <span class="label label-success">Remove Question</span></a></td>
		      </tr>
            ...
            %>
		      ...
		      if(str1!=null){
	             ...
	             prst.setString(7, answer);
	             prst.setString(8, marks);
