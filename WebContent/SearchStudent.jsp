		...
		<div id="page-wrapper">
			...
			<br/>
		      ...
		      String str1=request.getParameter("search");
	             ...
	             PreparedStatement prst=con.prepareStatement("select * from studentdata");
		      ...
		      <td><a href="DeleteStudent.jsp?id=<%out.println(""+rs.getString(1)); %>"> <span class="label label-success">Delete</span></a></td>
		      </tr>
